...
let name = await conn.getName(who)
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `💌 Developer Bot `, `I am Moonlight's husband`, `thightech22@gmail.com`, `🇮🇩 Srilanka`, `📍 https://github.com/hightech-lab`, `👤 Owner Of Queen Moonlight Bot`],
